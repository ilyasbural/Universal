namespace Universal.Presentation.Controllers
{
    ...
    public class CollegeController : BaseController<CollegeViewModel>
    {
        ...
        [HttpPost]
        public async Task<IActionResult> Create([Bind(Prefix = "Item1")] CollegeViewModel Model)
        {
            RestRequest = new RestRequest("api/college", Method.Post);
        ...
        [HttpPost]
        public async Task<IActionResult> Update([Bind(Prefix = "Item1")] CollegeViewModel Model)
        {
            RestRequest = new RestRequest("api/college", Method.Put);
            RestRequest.AddJsonBody(new { Name = Model.Name });
            RestRequest.RequestFormat = DataFormat.Json;
            RestResponse = await Client.ExecuteAsync(RestRequest);
        ...
        [HttpPost]
        public async Task<IActionResult> Delete([Bind(Prefix = "Item1")] CollegeViewModel Model)
        {
            RestRequest = new RestRequest("api/college", Method.Delete);
