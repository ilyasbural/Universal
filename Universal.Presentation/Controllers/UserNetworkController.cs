namespace Universal.Presentation.Controllers
{
    ...
    public class UserNetworkController : BaseController<UserNetworkViewModel>
    {
        public UserNetworkController(IConfiguration configuration) : base(configuration)
        {
        ...
        {
            RestRequest = new RestRequest("api/usernetwork", Method.Get);
            RestResponse = await Client.ExecuteAsync(RestRequest);
            Array = JObject.Parse(RestResponse.Content!);
            ModelList = Array["collection"]!.ToObject<List<UserNetworkViewModel>>()!;
        ...
        {
            RestRequest = new RestRequest("api/usernetwork", Method.Delete);
